...
class MultiPhaseRun(SystemRun):
    ...
    attesting: Attesting = field(default_factory=Attesting)
    slashing: Slashing = field(default_factory=Slashing)
    advance_slot: AdvanceSlot = field(default_factory=AdvanceSlot)
